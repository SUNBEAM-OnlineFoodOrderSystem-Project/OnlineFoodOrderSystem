...
//    public ResponseEntity<List<PendingOrderDTO>> getPendingOrders(@PathVariable Integer restaurantId) {
//        List<PendingOrderDTO> orders = orderService.getPendingOrdersForRestaurant(restaurantId);
//        return ResponseEntity.ok(orders);
//    }
//	
//    
...
////        Order updated = orderService.updateOrderStatus(dto.getOrderId(), dto.getStatus());
////        return ResponseEntity.ok(updated);
////    }
